<template>
  <LoadingView :loading="loading" :key="collectionId" class="o1-flex o1-flex-col o1-m-2">
    ...
    <RenameCollectionModal :collection="collection" :show="showRenameCollectionModal" @close="showRenameCollectionModal = false" />
    <DeleteCollectionModal :collection="collection" :show="showDeleteCollectionModal" @close="showDeleteCollectionModal = false" />
  </LoadingView>
</template>
