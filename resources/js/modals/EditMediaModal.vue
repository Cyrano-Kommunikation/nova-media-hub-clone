      ...
      <ModalContent class="!o1-overflow-visible">
        ...
        <div class="o1-mt-8 relative">
          <input v-model="inputTag" @input="handleInputChange" type="text"
                 ...
                 placeholder="Tags" @keydown.enter="addTag">
          <div v-show="showTagDropdown"
               class="o1-w-[394px] o1-absolute top[40px] o1-max-h-[150px] dark:o1-bg-gray-900 o1-z-10 o1-rounded o1-border-gray-300 o1-border dark:o1-border-gray-700 o1-mt-2 shadow o1-overflow-hidden o1-overflow-y-scroll"
          ...
          <div
            ...
            <div
              ...
              Es wurden keine Tags zugewiesen
            </div>
            <span
              class="o1-text-xs o1-px-3 o1-py-1 o1-bg-slate-700 o1-m-1 o1-rounded-xl o1-inline-block"
        ...
        <div class="o1-mt-4 relative">
          <div>
            ...
            <div v-show="showRoleDropdown"
                 class="o1-w-[394px] o1-absolute o1-top-[-60px] o1-max-h-[150px] dark:o1-bg-gray-900 o1-z-10 o1-rounded o1-border-gray-300 o1-border dark:o1-border-gray-700 o1-mt-2 shadow o1-overflow-hidden o1-overflow-y-scroll"
